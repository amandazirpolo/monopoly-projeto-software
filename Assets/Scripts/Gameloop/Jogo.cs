...
public class Jogo : MonoBehaviour
{
    ...
    [SerializeField][Range(0.1f, 1.0f)] private float moveSpeed; // Velocidade de movimento da pe�a
    ...
    IEnumerator movePecas()
    {
        ...
        // Verifica se a pe�a est� em uma dezena atr�s do jogador
        if ((piecePos / 10) < (currentPos / 10))
        {
            // Move a pe�a para a pr�xima dezena inteira
        ...
        // Move a pe�a para a posi��o final do jogador
